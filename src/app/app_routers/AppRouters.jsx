  ...
  return (
    <>
      <Switch>
        ...
        <Route path="/create_quiz_test_overview/:quizId" render={authGuard(CreateQuizOverview)} />
        <Route exact path="/create_quiz_test_question" component={CreateQuestion} />
        <Route exact path="/create_quiz_test_settings" render={authGuard(CreateQuizSettings)} />
        {/* -------------------- */}
