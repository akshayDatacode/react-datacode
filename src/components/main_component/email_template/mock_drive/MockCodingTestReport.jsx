...
class MockCodingTestReport extends Component {
  state = {};
  render() {
    return (
      <>
                          ...
                          <div clsassName="card text-white border border-white">
                            <a href="https://www.datacode.in/#/">
                              <img
                                ...
                                src="https://i.postimg.cc/8P5T4ZX8/4.png"
                                alt="avatar"
                              />
                            </a>
                          </div>
...
`}</p>
                            ...
                            >
                              <p className="pl-5 pr-5 pt-2 mx-auto">{`You can find your coding test report attached with this mail below.
  We will be sending out your interview slot soon.
...
`}</p>
                            ...
                            >
                              <p className="pl-5 pr-5 pt-3 mx-auto">{`Till then stayed tuned with us and
`}</p>
                            </div>
...
export default MockCodingTestReport;
