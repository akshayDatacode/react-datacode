...
class MockPlacementTestReport extends Component {
  state = {};
  render() {
    return (
      <>
                          ...
                          <div clsassName="card text-white border border-white">
                            <a href="https://www.datacode.in/#/">
                              <img
                                ...
                                src="https://i.postimg.cc/4yKDxtCr/2.png"
                                alt="avatar"
                              />
                            </a>
                          </div>
...
You can find your placement test report attached with this mail along with the answers for your self-assessment below.
`}</p>
                            </div>
                            ...
                            >
                              <p className="pl-5 pr-5 pt-2 mx-auto">{`  We will be sending out your coding test link soon
...
`}</p>
                            ...
                            >
                              <p className="pl-5 pr-5 mx-auto">{`Till then stayed tuned with us and
`}</p>
                            </div>
                            ...
                            >
                              <p className="pl-5 pr-5 pt-0">{`You can join our Placement Preparation Group by clicking on the link below`}</p>
                            </div>
                            <div
                              className="row text-white"
                              style={{
...
export default MockPlacementTestReport;
